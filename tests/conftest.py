...
def _frontend_learned_options(*, resource_profile: str | None = None) -> dict[str, object]:
    ...
    return {
        ...
        "runtime_targets": "auto,cpu,cuda,xpu,mps,nvidia,amd,intel,apple",
        "runtime_status": "cuda:unavailable,xpu:unavailable,mps:unsupported,cpu:available",
        "auto_runtime_priority": "cuda,xpu,cpu",
