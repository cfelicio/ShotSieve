...
|---|---|
| Library façade (operations / analysis / browser) | `runTrackedOperation`, `checkTrackedJob`, `checkTrackedOperation`, `resetReviewFiltersForAnalyze`, `runScan`, `runScore`, `prepareSelectedModel`, `analyzeLibrary`, `renderLibraryRoots`, `downloadDecisionCsv`, `installDecisionCsvEvents`, `clearCache`, `reviewMissingEntries`, `deleteSelectedFiles`, `navigateSelection`, `openOriginalFile`, `openBrowser`, `browseDirectory`, `chooseBrowserPath`, `handleError` |
