...
MODEL_CATALOG = (
    ...
    LearnedModelSpec(
        ...
        default_batch_size=4,
        max_batch_size=4,
        resource_labels=("2.2 GB weights", "under-4 GB claim", "CPU-compatible"),
        cache_families=("Hugging Face Hub cache",),
        required_cache_roots=("hf_hub_cache",),
        first_use_disclosure="First use downloads the Q-Future Q-ReAlign-Mini-0.8B checkpoint (about 2.2 GB of safetensors), tokenizer, processor, and configuration files. The authors claim under 4 GB of GPU memory and CPU support; verify actual peak memory and throughput on each target.",
        upstream_model_id="q-future/Q-ReAlign-Mini-0.8B",
        checkpoint_revision="fe1f45a7574c9e9d908875af9f7e90cb946aa19f",
    ),
)
